...
TEST(Dados,Diferencia)
{
  ...
  EXPECT_LT(d.diferencia(),6);//Espera un valor maximo de 5
  EXPECT_GT(d.diferencia(),-1);//Espera un valor minimo de 0
}
//Test para getLanzamientos
TEST(Dados,Lanzamientos)
{
  ...
  EXPECT_EQ(50,d.getLanzamientos1());
  EXPECT_EQ(50,d.getLanzamientos2());
